...
public class JoinFacet {
	...
	public void apply(DocIdInterface collector, Timer timer)
		...
		try {
			...
			ReaderInterface reader = resultSearch.getReader();
			int maxDoc = reader.maxDoc();
			for (FacetField facetField : facetFieldList)
				joinResult.add(facetField.getFacet(reader, JoinDocCollector
						.getDocIdInterface(maxDoc, joinResult.joinPosition,
								joinDocCollector), null, timer));
		} catch (IOException e) {
